...
export default class UserController {
  ...
  public static async getUser(req: RequestExpress, res: Response): Promise<any> {
  ...
  public static async getUsers(req: RequestExpress, res: Response): Promise<any> {
    const { page, size } = req.query
    return res.send(await UserService.getUsers({ page: Number(page), size: Number(size) }))
  }
